...
/// Handler for push notifications for season ranking (teamOfSeasonWin / teamOfSeasonLose)
class TeamOfSeasonRankingHandler extends PushHandler {
  @override
  void handle(Map<String, dynamic> payload, BuildContext context) async {
    beginLoading();
    try {
      final teamOfSeason = await context
